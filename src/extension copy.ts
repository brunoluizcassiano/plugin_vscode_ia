...
import { SettingsPanel } from './panel/settingsPanel';
 ...
 export async function activate(context: vscode.ExtensionContext) {
  // Criação da instância da HomeViewProvider com a URI da extensão
  ...
  await vscode.commands.executeCommand('homeView.focus', { preserveFocus: true });
   ...
   // Registro dos comandos que podem ser chamados pela extensão
  context.subscriptions.push(
  ...
  // Comando para abrir o painel Settings
  context.subscriptions.push(
