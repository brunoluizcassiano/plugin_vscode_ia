...
exports.buildAnaliseCenarioPrompt = void 0;
 ...
 */
function buildAnaliseCenarioPrompt(input) {
    const userStory = (0, shared_prompt_1.cleanText)(input.userStory);
    const cenarioOriginal = (0, shared_prompt_1.cleanText)(input.cenarioOriginal);
    return `
...
exports.buildAnaliseCenarioPrompt = buildAnaliseCenarioPrompt;
