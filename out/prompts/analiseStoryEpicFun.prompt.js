...
exports.buildAnaliseStoryEpicFunPrompt = void 0;
const shared_prompt_1 = require("./shared.prompt");
function buildAnaliseStoryEpicFunPrompt(input) {
    const description = (0, shared_prompt_1.cleanText)(input.description);
    const bdd = (0, shared_prompt_1.cleanText)(input.bdd);
    return `
...
exports.buildAnaliseStoryEpicFunPrompt = buildAnaliseStoryEpicFunPrompt;
